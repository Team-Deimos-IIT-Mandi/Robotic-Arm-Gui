...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /root/ros_ws/src/niwesh/kinova_urc_arm/third_party/gazebo-pkgs/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /root/ros_ws/devel/.private/gazebo_grasp_plugin)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /root/ros_ws/install)
...
if(NOT "/root/ros_ws/src/niwesh/kinova_urc_arm/third_party/gazebo-pkgs/gazebo_grasp_plugin/include " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/root/ros_ws/src/niwesh/kinova_urc_arm/third_party/gazebo-pkgs/gazebo_grasp_plugin/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_ws/src/niwesh/kinova_urc_arm/third_party/gazebo-pkgs/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ros_ws/devel/.private/gazebo_grasp_plugin/lib;/root/ros_ws/devel/lib;/opt/ros/noetic/lib)
