...
class VisionDetection:
    ...
    def publish_annotated_image(self, color_image, keypoints_2d, keyboard_bbox, keypoints_3d, session_coordinates, camera_frame, use_yolo, annotated_image_pub, real_pose_of_end_effector = None):
        ...
        try:
            ...
            current_pose = real_pose_of_end_effector.get_current_pose().pose


            if real_pose_of_end_effector is not None:
                pose_info = f"End Effector Pose: {current_pose.position.x:.3f}, {current_pose.position.y:.3f}, {current_pose.position.z:.3f}"

            else:
                pose_info = "End Effector Pose: N/A"
            ...
            status_lines = [
                ...
                f"real pose of end effector : {pose_info}",
                f"position of key 'V' in base frame: {keypoints_3d.get('A', {}).get('position', 'N/A')}"
